...
class PackageRating(Model):
    ...
    """
    def __init__(self, bus_factor: float=None, correctness: float=None, ramp_up: float=None, responsive_maintainer: float=None, license_score: float=None, good_pinning_practice: float=None, pull_request: float=None, net_score: float=None):  # noqa: E501
        ...
        :param pull_request: The pull_request of this PackageRating.  # noqa: E501
        :type pull_request: float
        :param net_score: The net_score of this PackageRating.  # noqa: E501
        :type net_score: float
        """
        self.swagger_types = {
            'bus_factor': float,
            'correctness': float,
    ...
    @property
    def pull_request(self) -> float:
        """Gets the pull_request of this PackageRating.

        The fraction of project code that was introduced through pull requests with a code review.  # noqa: E501

        :return: The pull_request of this PackageRating.
        :rtype: float
        """
        return self._pull_request

    @pull_request.setter
    def pull_request(self, pull_request: float):
        """Sets the pull_request of this PackageRating.

        The fraction of project code that was introduced through pull requests with a code review.  # noqa: E501

        :param pull_request: The pull_request of this PackageRating.
        :type pull_request: float
        """
    ...
    def net_score(self) -> float:
        """Gets the net_score of this PackageRating.

        Scores calculated from other seven metrics.  # noqa: E501

        :return: The net_score of this PackageRating.
        :rtype: float
        """
        return self._net_score

    @net_score.setter
    def net_score(self, net_score: float):
        """Sets the net_score of this PackageRating.

        Scores calculated from other seven metrics.  # noqa: E501

        :param net_score: The net_score of this PackageRating.
        :type net_score: float
        """
        if net_score is None:
            raise ValueError("Invalid value for `net_score`, must not be `None`")  # noqa: E501
