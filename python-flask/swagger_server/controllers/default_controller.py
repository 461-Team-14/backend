...
def package_by_name_delete(x_authorization, name):  # noqa: E501
...
def package_by_name_get(name, x_authorization):  # noqa: E501
    """package_by_name_get
...
def package_by_reg_ex_get(body, x_authorization):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        body = PackageRegEx.from_dict(connexion.request.get_json())  # noqa: E501
    if connexion.request.is_json:
        x_authorization = AuthenticationToken.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'
...
def package_delete(x_authorization, id):  # noqa: E501
...
def package_rate(id, x_authorization):  # noqa: E501
    """package_rate
...
def package_retrieve(x_authorization, id):  # noqa: E501
...
def package_update(body, x_authorization, id):  # noqa: E501
...
def packages_list(body, x_authorization, offset=None):  # noqa: E501
...
def registry_reset(x_authorization):  # noqa: E501
    """Reset the registry
